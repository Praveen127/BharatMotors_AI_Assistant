"""
_stdio_fallback_client.py
Client for _stdio_fallback_server.py, used automatically by mcp/client.py
when `fastmcp` is not installed. See that file's docstring.
"""
import sys
import os
import json
...
SERVER_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "_stdio_fallback_server.py")
